...
public:
    ...
    static void CreateRectangle2(float width, float height, float thickness/*, DataBuffer<DirectX::XMFLOAT2> pos, DataBuffer<DirectX::XMFLOAT2> aaVec, DataBuffer<uint16_t> idx*/);
